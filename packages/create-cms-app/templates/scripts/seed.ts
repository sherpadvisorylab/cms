...
async function seedNavigationComponents(cms: Awaited<ReturnType<typeof import("../src/lib/cms").cms.__proto__.constructor>>) {
  // We import CMS type loosely — the real CMS instance is passed from main()
