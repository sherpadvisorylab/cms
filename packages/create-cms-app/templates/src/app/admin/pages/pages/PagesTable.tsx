              ...
              {filtered.map((page) => (
                <tr key={page.id}>
                  ...
                  <td style={{ whiteSpace: "nowrap" }}>
                    <Link href={`/admin/pages/${page.id}/structure`} className="btn btn-secondary btn-sm"
                      style={{ marginRight: 4 }} title="Structure">⊞</Link>
                    <Link href={`/admin/pages/${page.id}/content`} className="btn btn-primary btn-sm">
                      Edit
                    </Link>
                  </td>
                </tr>
